        ...
        <div class="row bloco-container estagios pb-4 pb-md-5">
            ...
            <div class="col-12 col-md-8 pr-md-0">
                <ul class="text-justify mb-0 px-0">
                    ...
                    <li class="pb-4">A Lei Federal 11.788/2008, em seu art. 7º, inciso I, estabelece que o <strong>Termo de Compromisso de Estágio (TCE) é documento imprescindível</strong> para o início da atividade devendo ser emitida uma via original para cada parte participante do compromisso. O Plano de Atividades integra o Termo de Compromisso acompanhando cada via emitida.</li>

                    <li class="pb-4">O aluno <strong>NÃO PODE</strong> iniciar o estágio ou prática curricular no Serviço antes da assinatura do TCE e nenhum Termo será assinado pela PROGRAD ou a Instituição do Serviço retroativamente.</li>

                    <li class="pb-4">Todos os documentos devem conter todas as assinaturas originais.</li>

                    <li class="pb-4">Quando alguma parte não possuir carimbo, deverá escrever o nome legível e o nº do CPF abaixo da assinatura.</li>

                    <li class="pb-4">A <strong>DECLARAÇÃO DO ALUNO e PARECER DA COMGRAD</strong> para realização dos estágios obrigatórios e não obrigatórios pode ser encontrada <a href="https://www.ufrgs.br/prograd/wp-content/uploads/2019/12/Declara%C3%A7%C3%A3o-do-aluno-e-Parecer-COMGRAD-para-est%C3%A1gio-atualizado.pdf" target="_blank" class="font-weight-bold">aqui</a>.</li>
            ...
            <div>
                ...
                <div class="col-12 px-3 pt-2 px-md-0 pb-md-4 text-justify">
                    ...
                    <h4 class="fs-22 font-weight-bold pt-2 mb-4">Detalhes desse Convênio</h4>
                    <ol class="pl-0 mb-2">
                        <li class="pb-4">
                    ...
                    <h4 class="fs-22 font-weight-bold">Fluxo</h4>
                    <p>
