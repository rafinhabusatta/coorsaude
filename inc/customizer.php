<?php
/**
 * coorsaude-theme Theme Customizer
 *
...
function starter_theme_customize_preview_js() {
	wp_enqueue_script( 'coorsaude-theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
